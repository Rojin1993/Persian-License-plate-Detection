...
train_adad = torchvision.datasets.ImageFolder(root='C:/Users/rozhi/Downloads/Compressed/train_adad',
...
Data1, targets1 = oversample_images(train_adad)
train_adad1 = TensorDataset(Data1, targets1)

test_adad = torchvision.datasets.ImageFolder(root='C:/Users/rozhi/Downloads/Compressed/test_adad',
                                                   transform=torchvision.transforms.Compose([
                                                       torchvision.transforms.ToTensor(),
                                                       torchvision.transforms.Resize([90, 90]),
                                                       torchvision.transforms.Normalize(mean=0, std=1)
...
Data2, targets2 = oversample_images(test_adad)
test_adad1 = TensorDataset(Data2, targets2)

valid_adad = torchvision.datasets.ImageFolder(root='C:/Users/rozhi/Downloads/Compressed/valid_adad',
                                                   transform=torchvision.transforms.Compose([
                                                       torchvision.transforms.ToTensor(),
                                                       torchvision.transforms.Resize([90, 90]),
                                                       torchvision.transforms.Normalize(mean=0, std=1)
...
Data3, targets3 = oversample_images(valid_adad)
valid_adad1 = TensorDataset(Data3, targets3)
...
Train_size = len(train_adad1)
Valid_size = len(valid_adad1)
Test_size = len(test_adad1)

# DataLoader
train_loader = torch.utils.data.DataLoader(dataset=train_adad1, batch_size=train_b_s, shuffle=True,
                                               generator=torch.Generator().manual_seed(0), num_workers=0)
valid_loader = torch.utils.data.DataLoader(dataset=valid_adad1, batch_size=valid_b_s, shuffle= True,
                                               generator=torch.Generator().manual_seed(0), num_workers=0)
test_loader = torch.utils.data.DataLoader(dataset=test_adad1, batch_size=test_b_s,
                                               generator=torch.Generator().manual_seed(0), num_workers=0)
...
PATH = 'R:/horoof'
torch.save(model, os.path.join(PATH, 'Augdensenet-numbers90.pth'))
